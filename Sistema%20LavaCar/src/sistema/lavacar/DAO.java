...
abstract class DAO {
    ...
    abstract public void saveData(Estoque obj, String name) throws FileNotFoundException;
            
    abstract public Estoque recoverData(Estoque obj, String name) throws FileNotFoundException;
