...
//            switch(opcao){
//                case 1:
//                    interf.mostrarFila(getService().getFila());
...
//                    break;
//                case 3:
//                    interf.mostrarPrecos(getService());
//                    querVoltar = true;
//                    break;
//                case 4:
//                    interf.mostrarInfo(getName_company(), getAddress_company(), getPhone_company(), getSite_company(), getCnpj());
//                    querVoltar = true;
//                    break;
//                default:
//                    interf.menuPrincipal(getName_company());
//                    opcao = input.nextInt();
//            }
//            if(querVoltar == true)
//            {
...
//        }while(opcao > 0);
        ...
        switch(opcao)
        {
            ...
            case 2:
              //  cadastrarVeiculo();
                break;
            case 3:
                double valor = getService().executar();
                if(valor != 0)
    ...
    public void criaVeículo(String s)
    {
        Scanner input = new Scanner(System.in);
